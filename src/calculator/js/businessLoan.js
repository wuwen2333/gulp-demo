$(document).ready(function(){
  ...
  businessLoan.loanTerm = function() {
  ...
  businessLoan.calculateMethod = function() {
  ...
  businessLoan.repaymentMethod = function() {
  ...
  businessLoan.handleInput = function() {
